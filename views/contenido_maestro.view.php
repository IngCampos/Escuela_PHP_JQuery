...
while($materias!=null){
	echo "<tr><td>".$materias["Hora"]."</td><td>".$materias["Nombre"]."</td><td><center>".$materias["Grado"]."</center></td><td><center><a class='fa fa-edit' href='control.php?id_clase=".$materias["Id"]."'></a></center></td></tr>";
	$materias = $statement->fetch();
}
echo "</table>";